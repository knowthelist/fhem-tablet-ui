        ...
        .each(function(index) {
            ...
            if ( !(isNaN(value_high) || isNaN(value_low)) ) {
                ...
                if (levelRange ) {
                  ...
                  var colorHigh = getStyle('.'+elem.data('color-high'),'color') || elem.data('color-high');
                  var color     = getStyle('.'+elem.data('color'),'color')      || elem.data('color');
                  var colorLow  = getStyle('.'+elem.data('color-low'),'color')  || elem.data('color-low');
