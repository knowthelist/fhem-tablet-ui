...
var Modul_verkehrsinfo = function () {
    ...
    function init () {
        ...
        this.elements.each(function(index) {
			...
			console.log("device: " + device + " icon: " + $(this).data('icon') + " max a: " + $(this).data('max') + " count: " + elem.getReading('count').val);	
		});
	};
			...
			if (elem.data('shadow-head') == true) { var shadowhead = 'text-shadow: 2px 0px 2px rgba(0,0,0,0.6), 0px 2px 2px rgba(255,255,255,0.4);min-width:150px;-moz-transform: translate(-1px, -5px);-o-transform: translate(-1px, -5px);-ms-transform: translate(-1px, -5px);transform: translate(-1px, -5px);' } else { var shadowhead = 'min-width:150px;'};
				...
				if ( count >= elem.data('max') ) { count = elem.data('max'); } 
					...
					for (var i = 1; i <= count; i++) {
						...
						if (typeof elem.getReading('msg').val !== "undefined") {
						...
						//console.log("road: " + elem.getReading('road').val + " head: " + elem.getReading('head').val + " i = e_" + i + " data-icon=" + icon);	
							...
							if (icon == '2')
							{
								...
								if (typeof elem.getReading('road').val == "undefined") {

								}else if  (elem.getReading('road').val.substring(0, 1) == 'A')
								{	
								...
								{
									text += "<table border=\"0px\" style=\"width:100%\"><tr><th align=\"center\" width=\"15%\"><div class=\"cell\" style=\"" + shadow + "height:18px;padding:0;border-radius:4px;background-color: rgba(0,0,0,0.1);background:#FFFFFF;color:#000000;text-align:center;font-size:12px;margin:0 0 5px 0;border:1px solid #ccc;border-color:#000000;line-height:18px;\">" + elem.getReading('road').val + "</div></th>";
									text += "<th><div class=\"cell\" style=\"" + shadowhead + "display:inline-block;padding:4px;font-weight:bold;color:" + color_head + ";border-radius:4px;\">" + elem.getReading('head').val + "</div></th>";
									text += "<th align=\"center\" width=\"15%\"><div class=\"cell\" style=\"" + shadow + "height:18px;padding:0;border-radius:4px;background-color: rgba(0,0,0,0.1);background:#FFFFFF;color:#000000;text-align:center;font-size:12px;margin:0 0 5px 0;border:1px solid #ccc;border-color:#000000;line-height:18px;\">" + elem.getReading('road').val + "</div></th>";	
									text += "</tr><tr><td colspan=\"3\"><div class=\"cell top-narrow-10\" style=\"color:" + color_msg + ";\">" + elem.getReading('msg').val + "</div></td></tr></table>";
									text += "</div>";	
							...
							if  (icon == '1')
							{
								...
								{
									text += "<table border=\"0px\" style=\"width:100%\"><tr><th rowspan=\"2\" align=\"center\" width=\"10%\"><div class=\"cell\" style=\"" + shadow + "height:18px;padding:0;border-radius:4px;background-color: rgba(0,0,0,0.1);background:#FFFFFF;color:#000000;text-align:center;font-size:12px;float:left;margin:0 0 5px 0;border:1px solid #ccc;border-color:#000000;line-height:18px;\">" + elem.getReading('road').val + "</div></th>";
									text += "<th><div class=\"cell\" style=\"" + shadowhead + "display:inline-block;padding:4px;font-weight:bold;color:" + color_head + ";border-radius:4px;\">" + elem.getReading('head').val + "</div></th>";
									text += "</tr><tr><td><div class=\"cell top-narrow\" style=\"color:" + color_msg + ";\">" + elem.getReading('msg').val + "</div></td></tr></table>";
									text += "</div>";
							...
							if (elem.data('icon') == "no") 
							{
								...
								}else if  (elem.getReading('road').val.substring(0, 1) == '-')
								{
