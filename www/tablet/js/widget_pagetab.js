    ...
    function init () {
        ...
        if ( ! dl ) {
          ...
          me.elements.each(function(index) {
              var elem = $(this);
              elem.initData('off-color'             , getStyle('.'+me.widgetname+'.off','color')   || '#606060');
              elem.initData('off-background-color'  , getStyle('.'+me.widgetname+'.off','background-color')   || 'transparent');
              elem.initData('on-color'              , getStyle('.'+me.widgetname+'.on','color')               || '#222222');
              elem.initData('on-background-color'   , getStyle('.'+me.widgetname+'.on','background-color')    || '#606060');
