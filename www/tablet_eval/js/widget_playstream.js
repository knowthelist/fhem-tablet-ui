...
var Modul_playstream = function () {
    ...
    function init() {
        ...
        me.elements.each(function(index) {
            var elem = $(this);
            elem.initData('off-color'               ,getStyle('.playstream.off','color') || '#2A2A2A');
            elem.initData('off-background-color'    ,getStyle('.playstream.off','background-color')   || '#505050');
            elem.initData('on-color'                ,getClassColor(elem) || getStyle('.playstream.on','color')               || '#2A2A2A');
            elem.initData('on-background-color'     ,getStyle('.playstream.on','background-color')    || '#aa6900');
